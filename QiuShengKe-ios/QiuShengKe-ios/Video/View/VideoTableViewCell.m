...
- (void)loadData:(NSDictionary *)dic{
    ...
    [_league setText:[[dic stringForKey:@"lname" withDefault:@""] stringByAppendingString:[NSString stringWithFormat:@" %@",[NSDate stringWithFormat:@"MM-dd HH:mm" withTime:[[dic objectForKey:@"time"] longLongValue]]]]];
